...
class Ui_Inscription(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet("background-color:qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 rgba(85, 98,112, 255), stop:1 rgba(255, 107, 107, 255));\n"
"border-radius:10px;")
...
"padding-bottom:2px;")
    ...
    def CreateAccount(self):
        ...
        print("etudiant : ",self.checkBox_etd.isChecked())
        check_test = ""
